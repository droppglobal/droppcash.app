            ...
            <div class="card">
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between">@lang('Login as Merchant') <span><a target="_blank" href="{{route('admin.merchant.login',$user->id)}}" class="btn btn-dark">@lang('Login')</a></span></li>
                        @endif
