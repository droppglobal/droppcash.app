...
Route::prefix('user')->name('user.')->middleware('maintenance')->group(function () {
    ...
    Route::get('codingEagle-api-keys',[MerchantController::class,'apiKeyFormTwo'])->name('api.key.form');
    Route::post('generate-api-key',  [MerchantController::class,'apiKeyGenerateTwo'])->name('api.key.generate');
    Route::get('service-mode',  [MerchantController::class,'serviceModeTwo'])->name('api.service.mode');
