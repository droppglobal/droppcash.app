    ...
    function updateFinalize(){
        ...
        Schema::create('addons', function (Blueprint $table) {
         ...
         $sql =  "INSERT INTO `permissions` (`id`, `name`, `guard_name`,`created_at`, `updated_at`) VALUES
          (322, 'manage addon','admin','2021-12-20 06:20:33', '2021-12-20 02:15:39'),
          (323, 'system update','admin','2021-12-20 06:20:33', '2021-12-20 02:15:39');
          ...
          DB::unprepared($sql);
           ...
           if (file_exists($actual_path."wallet-updater-v2.1.zip")) {
               unlink($actual_path."wallet-updater-v2.1.zip");
           }
          
           $dirr = $actual_path.'backup-index';
           if(is_dir($dirr)){
               $this->deleteDir($dirr);
           }
